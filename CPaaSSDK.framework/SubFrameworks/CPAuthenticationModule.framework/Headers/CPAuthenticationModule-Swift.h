...
#ifndef CPAUTHENTICATIONMODULE_SWIFT_H
#define CPAUTHENTICATIONMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CPAuthenticationModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// since:
/// 1.0.0
SWIFT_PROTOCOL("_TtP22CPAuthenticationModule24CPAuthenticationDelegate_")
...
/// since:
/// 1.0.0
SWIFT_CLASS("_TtC22CPAuthenticationModule23CPAuthenticationService")
