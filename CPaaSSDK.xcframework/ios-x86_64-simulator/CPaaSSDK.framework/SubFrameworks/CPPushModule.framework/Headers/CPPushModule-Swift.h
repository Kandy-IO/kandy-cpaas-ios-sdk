...
#ifndef CPPUSHMODULE_SWIFT_H
#define CPPUSHMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CPPushModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC12CPPushModule8CPCKInfo")
...
/// since:
/// 1.0.0
SWIFT_CLASS("_TtC12CPPushModule13CPPushService")
@interface CPPushService : NSObject
...
///
- (void)subscribeWithCompletion:(void (^ _Nonnull)(CPError * _Nullable, NSString * _Nullable))completion;
/// Unsubscribe from the Push Service with the given callback URL.
/// \param ofURL Callback URL of the push service
///
/// \param completion Invokes <em>PushSubscriptionBlock</em> when operation is finished
///
- (void)unsubscribeWithCompletion:(void (^ _Nonnull)(CPError * _Nullable))completion;
...
/// \param completion Invokes <em>PushSubscriptionBlock</em> when operation is finished
///
- (void)checkPushSubscriptionWithCompletion:(void (^ _Nonnull)(CPError * _Nullable, NSString * _Nullable))completion;
/// When push message arrived injectPushMessage should be called.
/// Notifies services to act according to the message.
/// \param pushMessage The push message string taken from payload.
///
- (void)injectPushMessageWithPushMessage:(NSDictionary * _Nonnull)pushMessage completion:(void (^ _Nonnull)(CPError * _Nullable))completion;
/// Resubscribes to Push Services with the given device token
/// \param standardDeviceToken The device token to use subscription operations.
///
/// \param voipDeviceToken The device token to use subscription operations.
///
/// \param completion Invokes <em>PushSubscriptionBlock</em> when operation is finished
///
...
/// since:
/// 2.5.0
/// \param pushMessage Incoming push data
///
///
/// returns:
/// CPCKInfo
